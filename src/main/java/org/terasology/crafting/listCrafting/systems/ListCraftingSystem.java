...
@RegisterSystem
public class ListCraftingSystem extends BaseComponentSystem {
    @In
    ...
    public void onActivate(ActivateEvent event, EntityRef entity) {
        ListRecipe recipe = (ListRecipe) recipeStore.getRecipe(0);
        craftingManager.craftRecipe(localPlayer.getCharacterEntity(), recipe, true);
    }
